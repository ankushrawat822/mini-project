...
const Footer = () => {
    return (
        <>
            <section className='relative footer-bg mt-20 flex  flex-col-reverse items-center sm:flex-row sm:flex-wrap sm:items-start justify-evenly pt-14 pb-36 md:px-5 lg:py-5 lg:pt-20  lg:px-10 gap-14 sm:gap-5 xl:gap-0'>
                {/* company */}
              ...
              text-[18px] gap-3 sm:gap-4'>
                ...
                {/* <div className=' flex flex-col items-center justify-center sm:w-[290px] md:w-full md:px-10 xl:w-[449px] md:mt-6 xl:mt-0'>
                 ...
                 <div className='absolute bottom-0  mt-12 pb-10'>
                  ...
                  {/* folow */}
                    <div className='flex items-center justify-e text-[20px]  gap-4 '>
                    ...
                    {/* copyright */}
                    {/* <p className='text-[16px] font-bold text-center'>Fluent-Speech</p> */}
                  </div>
                 </div>
            </section>
        </>
